...
require('lazy').setup({
  ...
  -- link). 'tpope/vim-sleuth', -- Detect tabstop and shiftwidth automatically
  ...
  --  This is moved to custom/plugins/comment.lua
  ...
  -- repo, not just copy pasted the init.lua. If you want these files, they are
  -- in the repository, so you can just download them and place them in the
  -- correct locations.
